...
public class DalilaVolatileCollection_D0Logic
{
    ...
    [DataContract()]
    class User : DalilaDBVolatileCollection<User>
    {
    ...
    [Test]
    public void A220_FindMany_01WillFindAnArrayOrEmptyArrayButNeverNull()
    {
    ...
    public void A300_UpdateById_61InvalidOrNullKeyOrUpdateFunc_WillThrowError()
    {
        ...
        // Find the document by the id
        Assert.Throws<ArgumentNullException>(() => User.UpdateById(d => { d.count = 88; return d; }, null));
        Assert.Throws<ArgumentNullException>(() => User.UpdateById(d => { d.count = 88; return d; }, ""));
        Assert.Throws<FormatException>(() => User.UpdateById(d => { d.count = 88; return d; }, "343432"));
        Assert.Throws<FormatException>(() => User.UpdateById(d => { d.count = 88; return d; }, "f43f34ff"));
        Assert.Throws<FormatException>(() => User.UpdateById(d => { d.count = 88; return d; }, "4332 333 444 55  22"));
        Assert.Throws<FormatException>(() => User.UpdateById(d => { d.count = 88; return d; }, "433232893874673.254"));
