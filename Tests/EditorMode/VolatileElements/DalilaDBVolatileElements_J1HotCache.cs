...
public class DalilaVolatileElements_J1HotCache
{
    ...
    [Test]
    public void DalilaVolatileElements_HotCacheEnabled_ValueTypes()
    {
    ...
    [Test]
    public void DalilaVolatileElements_HotCacheEnabled_ReferenceTypes()
    {
